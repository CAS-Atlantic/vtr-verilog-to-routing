...
static std::string arithmetic(std::string op, std::string a_in) {
    ...
    return (
               (op == "to_unsigned") ? V_UNSIGNED(a) : (op == "to_signed") ? V_SIGNED(a) : (op == "~") ? V_BITWISE_NOT(a) : (op == "-") ? V_MINUS(a) : (op == "+") ? V_ADD(a) : (op == "&") ? V_BITWISE_AND(a) : (op == "|") ? V_BITWISE_OR(a) : (op == "^") ? V_BITWISE_XOR(a) : (op == "~&") ? V_BITWISE_NAND(a) : (op == "~|") ? V_BITWISE_NOR(a) : (op == "~^" || op == "^~") ? V_BITWISE_XNOR(a) : (op == "!") ? V_LOGICAL_NOT(a) : bad_ops(op))
        .to_full_string();
}
